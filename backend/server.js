...
app.get("/createlibrarytable", (req, res) => {
  let sql =
    "CREATE TABLE library(rollno INT NOT NULL,bookName VARCHAR(50), firstname VARCHAR(50),lastname VARCHAR(50),name VARCHAR(100) AS (CONCAT(firstname,' ',lastname)),age INT, email VARCHAR(50),faculty VARCHAR(50) NOT NULL, semester VARCHAR(50) NOT NULL,college VARCHAR(50) NOT NULL,batch VARCHAR(255) NOT NULL,dob DATE,id VARCHAR(255) AS (CONCAT(college,batch,faculty,rollno)) UNIQUE)";
